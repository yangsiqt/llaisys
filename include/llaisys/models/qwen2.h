...
__C {
    ...
    __export int llaisysQwen2TPModelPrefillSlotsVarlen(struct LlaisysQwen2TPModel *model, size_t *slot_ids, int64_t *token_ids, size_t *prompt_lens, int64_t *out, size_t nslot, size_t max_prompt_len);
