...
#include "ascend/rope_ascend.hpp"
#endif
...
void rope(tensor_t out, tensor_t in, tensor_t pos_ids, float theta) {
    ...
    case LLAISYS_DEVICE_ASCEND:
        return ascend::rope(out->data(), in->data(), reinterpret_cast<const int64_t *>(pos_ids->data()), theta, out->dtype(), seq_len, n_heads, head_dim);
#endif
    default:
